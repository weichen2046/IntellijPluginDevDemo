...
public class DemoVirtualFile extends VirtualFile {
    private static final String NAME = "Demo Editor";
    private static final String PATH = "Demo Editor.demo";

    public static final DemoVirtualFile INSTANCE = new DemoVirtualFile();
